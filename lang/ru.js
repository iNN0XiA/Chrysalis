...
module.exports = {
  meta: {
    name: 'Russian',
        new_lang_message: `Извините, а Я только немножко по-русски говорю...`
  },
  author: 'Author',
  message: 'Message',
  channel: 'Channel',
  ...
  module_already_enabled: 'Module {0} was already enabled.',
  module_already_disabled: 'Module {0} was already disabled.',
  ...
  role_id: 'Role ID',
  welcome: 'Welcome!',
  you_are_the_member_n: 'You are member Nº{0}',
  ...
  messages_deleted: `{0} message(s) deleted! ${emojis.PinkiePieYes}`,
  optional: 'optional',
